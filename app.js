...
// const botonClima = document.getElementById('temperaturaInfo');
...
//         cuerpoTabla.appendChild(fila.appendChild(td1));
//         cuerpoTabla.appendChild(fila.appendChild(td2));
//         cuerpoTabla.appendChild(fila.appendChild(td3));
//         console.log(fila);
